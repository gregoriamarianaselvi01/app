...
<html lang="en">
  <head>
    ...
    <title>Gregoria Mariana Selvi - Software Engineer</title>
  </head>
  <body>
    <!-- Header -->
    <header>
      <div class="main-container">
        ...
        <section id="hero">
          <div class="hero-left">
            ...
            <h1 class="hero-name">Gregoria <span>Mariana Selvi</span></h1>
            <p>
          ...
          <div class="hero-right">
            <img src="./images/gregoria.png" alt="Person Standing" />
          </div>
        </section>
      </div>
    </header>
      ...
      <div class="skills main-container">
        ...
        <div class="skills-grid">
          <div class="skills-left">
            <div class="education">
              ...
              <div class="education-info">
                <h4 class="education-title">Universitas Kristen Immanuel</h4>
                <p>Bachelor Degree - Informatics Engineering</p>
            ...
            <div class="education">
              ...
              <div class="education-info">
                <h4 class="education-title">Kampus Mengajar #5</h4>
                <p>Peserta Program - MBKM Kampus Merdeka</p>
                <h4 class="education-years">January - June 2023</h4>
              </div>
            </div>
            <div class="education">
              <div class="line">
              ...
              <div class="education-info">
                <h4 class="education-title">Bangkit Akademy By Google, GoTo, Traveloka</h4>
                <p>Cloud Computing - CC-26 </p>
                <h4 class="education-years">August - December 2023</h4>
              </div>
            </div>
          </div>
          ...
          <div class="skills-right">
            <p>
              Starting to learn as a web developer from 2020 until 
              now makes me master several programming languages and 
              supporting tools. Continuing to learn either independently 
              from YouTube, documented or taking courses is my way to 
              explore all of this because technology will continue to 
              develop every day so with full self-awareness I also 
              have to upgrade my skills every day.
            </p>
      ...
      <div class="contact main-container">
        ...
        <div class="contact-right">
          ...
          <div class="contact-item">
            ...
            <div class="contact-item-detail">
              <h4>Email</h4>
              <p>gregoriamarianaselvi@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer>
      ...
      <p>&#169; 2023 - Gregoria Mariana Selvi</p>
    </footer>
    <!-- End Footer -->
